...
<section
    ...
    >
        <div
            class="px-16 flex flex-col lg:justify-center text-center lg:text-left gap-8 md:gap-10 lg:gap-12"
        >
            <h2
            ...
            >
                ...
                <div class="py-6"></div>
                <img src="images/cu-robotics/robotics-team.png" alt="">
                <div class="py-4"></div>
                demos comming soon...
                <br />
            </h2>
...
<div ><StaticGallery image_src={robots}/></div>
